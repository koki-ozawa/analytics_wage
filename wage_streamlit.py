...
df_jp_category = pd.read_csv('./csv_data2020/雇用_医療福祉_一人当たり賃金_全国_大分類.csv', encoding='shift-jis')
...
df_pref_mean = df_pref_mean[df_pref_mean['都道府県名'] == option]
df_mean_line = pd.merge(df_mean, df_pref_mean, on='集計年')
...
df_mean_catg = df_jp_category[df_jp_category['集計年'] == option_year]
